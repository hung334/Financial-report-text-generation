...
if __name__ == '__main__':
    ...
    for dic_num in range(len(dic)):#(47,48):
            ...
            if(len(property_kgs)!=0):
                ...
                train_dataset.at[train_dataset_count, 'summary'] = paragraphs_text#summary
                train_dataset.at[train_dataset_count, 'summary_mask'] = mask_paragraphs_text#mask_summary
